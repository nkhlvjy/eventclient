...
const Event = (props: EventProps) => {
  ...
  const startTime = new Date(props.event.startTime).toLocaleTimeString([], { hour: 'numeric', minute: '2-digit', hour12: true });
  const endTime = new Date(props.event.endTime).toLocaleTimeString([], { hour: 'numeric', minute: '2-digit', hour12: true });
  return (
    <Card>
      <div className="event">
